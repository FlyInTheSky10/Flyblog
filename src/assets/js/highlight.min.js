...
!
function(e) {
    "undefined" != typeof exports ? e(exports) : (self.hljs = e({}), "function" == typeof define && define.amd && define("hljs", [],
    function() {
        return self.hljs
    }))
} (function(e) {
    ...
    function l(e) {
        ...
        function a(n, i) {
            if (!n.compiled) {
                ...
                n.lR = r(n.l || /\b\w+\b/, !0),
                i && (n.bK && (n.b = "\\b(" + n.bK.split(" ").join("|") + ")\\b"), n.b || (n.b = /\B|\b/), n.bR = r(n.b), n.e || n.eW || (n.e = /\B|\b/), n.e && (n.eR = r(n.e)), n.tE = t(n.e) || "", n.eW && i.tE && (n.tE += (n.e ? "|": "") + i.tE)),
                n.i && (n.iR = r(n.i)),
                void 0 === n.r && (n.r = 1),
                n.c || (n.c = []);
                var l = [];
    ...
    function u(e, r, n, i) {
        ...
        function h(e, r) {
            var a = e.cN ? p(e.cN, "", !0) : "";
            e.rB ? (M += a, E = "") : e.eB ? (M += t(r) + a, E = "") : (M += a, E = r),
            x = Object.create(e, {
                parent: {
                    value: x
                }
        ...
        try {
            for (var z, $, L = 0;;) {
                if (x.t.lastIndex = L, z = x.t.exec(r), !z) break;
                $ = _(r.substr(L, z.index - L), z[0]),
                L = z.index + $
            }
    ...
    function b(e) {
        return w.tabReplace && (e = e.replace(/^((<[^>]+>|\t)+)/gm,
        function(e, t) {
    ...
    function(e) {
        ...
        i = e.IR + "\\s*\\(",
        s = {
            keyword: "while private catch export virtual operator sizeof dynamic_cast|10 typedef const_cast|10 const struct for static_cast|10 union namespace unsigned volatile static protected template mutable if do goto enum else break extern using class asm case typeid reinterpret_cast|10 default explicit signed typename try this switch continue delete alignof constexpr decltype noexcept static_assert thread_local restrict _Bool _Complex _Imaginary atomic_bool atomic_char atomic_schar atomic_uchar atomic_short atomic_ushort atomic_int atomic_uint atomic_long atomic_ulong atomic_llong atomic_ullong",
            types: "int float char long bool public friend auto void short double inline complex register",
